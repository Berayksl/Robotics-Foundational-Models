...
from tasks.room_nav_task import RoomNavTask
from tasks.room_visit_task import RoomVisitTask
...
class MultiTaskSampler(AbstractSPOCTaskSampler):
    ...
    def increment_task_and_reset_house(
        ...
        nav_only_tasks = [t.task_type_str for t in [RoomVisitTask, ObjectNavTask, RoomNavTask]]
        tasks_are_nav_only = (
