#RETURNS THE LOGITS INSTEAD OF PROBS
...
class EarlyFusionCnnTransformer_Modified(nn.Module):
    def __init__(
        self,
    ...
    def build_model(
        ...
        model = EarlyFusionCnnTransformer_Modified(model_cfg)
...
class EarlyFusionCnnTransformerAgent(AbstractAgent):
    ...
    def get_action(self, observations, goal_spec):
        ...
        return action, curr_logits.detach().cpu().numpy()