...
def calculate_predicate_robustness(trajectory, goal_center, goal_radius):
    """
    ...
    distances = [np.linalg.norm(np.array(state) - np.array(goal_center)) for state in trajectory]
