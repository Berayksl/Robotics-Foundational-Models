...
class OnlineEvaluatorWorker:
    ...
    def evaluate_on_task(self, task: AbstractSPOCTask, agent: AbstractAgent, worker_id: int):
        ...
        # =========================
        display_realtime = True           # first-person (nav+manip) window
        display_topdown_realtime = False   # topdown third-party camera window
        ...
        save_topdown_each_step = False
        save_firstperson_hr_each_step = True
        ...
        actions = ['m', 'm', 'm', 'm', 'm', 'm', 'r', 'r', 'm', 'r', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'l', 'b', 'r', 'm', 'r', 'm', 'l', 'm', 'l', 'b', 'b', 'b', 'm', 'l', 'b', 'b', 'm', 'm', 'm', 'l', 'm', 'm', 'r', 'l', 'b', 'r', 'm', 'r', 'm', 'r', 'm', 'b', 'm', 'b', 'l', 'r', 'l', 'm', 'b', 'l', 'm', 'm', 'l', 'b', 'b', 'b', 'b', 'b', 'm', 'r', 'b', 'r', 'b', 'b', 'b', 'b', 'l', 'b', 'm', 'l', 'r', 'r', 'b', 'b', 'b', 'b', 'b', 'r', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'm', 'm', 'm', 'm', 'l', 'm', 'l', 'l', 'r', 'r', 'ls', 'l', 'b', 'r', 'r', 'r', 'b', 'b', 'r', 'b', 'b', 'b', 'b', 'r', 'm', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'm', 'b', 'b', 'b', 'b', 'r', 'b', 'l', 'l', 'b', 'r', 'r', 'l', 'b', 'l', 'r', 'r', 'l', 'b', 'm', 'l', 'm', 'l', 'm', 'm', 'l', 'l', 'm', 'm', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'm', 'm', 'l', 'ls', 'end']

        #actions = ['m', 'm', 'm', 'm', 'm', 'm', 'r', 'r', 'm', 'r', 'm', 'm', 'm', 'm', 'm', 'b', 'b', 'm', 'm', 'm', 'm', 'l', 'm', 'm', 'm', 'l', 'm', 'm', 'r', 'b', 'm', 'l', 'b', 'b', 'l', 'b', 'r', 'm', 'l', 'm', 'm', 'r', 'l', 'l', 'l', 'l', 'rs', 'l', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'l', 'm', 'l', 'r', 'l', 'r', 'm', 'm', 'm', 'm', 'b', 'r', 'r', 'r', 'r', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'r', 'r', 'm', 'm', 'm', 'm', 'm', 'r', 'm', 'r', 'r', 'm', 'm', 'r', 'l', 'r', 'l', 'r', 'm', 'l', 'rs', 'r', 'rs', 'l', 'l', 'l', 'l', 'r', 'r', 'r', 'r', 'ls', 'b', 'm', 'b', 'b', 'b', 'r', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'l', 'r', 'm', 'l', 'l', 'l', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'end']
        #actions = ['m', 'm', 'm', 'm', 'm', 'm', 'r', 'r', 'm', 'r', 'm', 'm', 'm', 'm', 'm', 'b', 'b', 'm', 'm', 'm', 'm', 'l', 'm', 'm', 'm', 'l', 'm', 'm', 'r', 'b', 'm', 'l', 'b', 'b', 'l', 'b', 'r', 'm', 'l', 'm', 'm', 'r', 'l', 'l', 'l', 'l', 'rs', 'l', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'l', 'm', 'l', 'r', 'l', 'r', 'm', 'm', 'm', 'm', 'b', 'r', 'r', 'r', 'r', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'r', 'r', 'm', 'm', 'm', 'm', 'm', 'r', 'm', 'r', 'r', 'm', 'm', 'r', 'l', 'r', 'l', 'r', 'm', 'l', 'rs', 'r', 'rs', 'l', 'l', 'l', 'l', 'r', 'r', 'r', 'r', 'ls', 'b', 'm', 'b', 'b', 'b', 'r', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'l', 'r', 'm', 'l', 'l', 'l', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'l', 'm', 'm', 'm', 'm', 'm', 'm', 'm', 'r', 'end']
        try:
            with torch.no_grad():
                ...
                for eps_idx in range(task.max_steps):
                    ...
                    if display_topdown_realtime and hasattr(ev, "third_party_camera_frames"):
                        ...
                        if frames is not None and len(frames) > 0:
                            ...
                            upscaled = upscaled[:,555:w-555] #crop to remove the background
