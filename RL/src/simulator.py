...
from funnel_reward import FunnelReward, FunnelSpec
...
class Continuous2DEnv:
    ...
    def _precompute_free_spawn_cells(self, resolution=0.20, seed_xy=None, max_cells=100_000):
        """
...
if __name__ == "__main__":
    ...
    config = {
        'house_index': 30,
        'init_loc':[1.5, 2, 90], #initial location of the agent (x, y)
        "dt": 1,
        "render": True,
		'dt_render': 0.1,
